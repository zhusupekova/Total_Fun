...
## О проекте
Лёгкий прототип 3D PvP-игры на 4 игроков, рассчитанный на Telegram WebView. Основная цель — показать core-геймплей с кастомной плоской физикой мяча, стабильным FPS и простым управлением на мобайле. Архитектура: клиент на Three.js (Next.js-оболочка), отдельный WS-сервер для расчёта физики и синхронизации.
